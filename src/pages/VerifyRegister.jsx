  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    <div className="pt-32 pb-12 md:pt-40 md:pb-20">
      ...
      <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
        <h1 className="h1">Verified! <br></br>Fill the form below to continue registration.</h1>
      </div>
        ...
        <form onSubmit={Regist}>
          ...
          <div className="flex flex-wrap -mx-3 mb-4">
            <div className="w-full px-3">
              ...
              <input id="username" type="text" className="block w-full flex-1 rounded-md border-gray-400 focus:border-blue-500 focus:ring-blue-500 sm:text-sm mb-3 placeholder:text-gray-300" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="input your username"/>
            </div>
          </div>
          ...
          <div className="flex flex-wrap -mx-3 mb-4">
            <div className="w-full px-3">
              ...
              <input id="password" type={'password'} className="block w-full flex-1 rounded-md border-gray-400 focus:border-blue-500 focus:ring-blue-500 sm:text-sm mb-3 placeholder:text-gray-300" value={confPassword} onChange={(e) => setConfPassword(e.target.value)} placeholder="input your password"/>
            </div>
          </div>
          ...
          <div className="flex flex-wrap -mx-3 mb-4">
            <div className="w-full px-3">
              ...
              <input id="confpassword" type={'password'} className="block w-full flex-1 rounded-md border-gray-400 focus:border-blue-500 focus:ring-blue-500 sm:text-sm mb-3 placeholder:text-gray-300" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="input your password"/>
            </div>
          </div>
