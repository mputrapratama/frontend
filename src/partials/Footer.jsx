...
import getItOnPs from '../images/vecteezy_get-it-on-play-store-button-and-apple-app-store-icon_-removebg-preview (1).png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a href='http://twitter.com/renn_tutorial' target={'_blank'} className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter" rel="noreferrer">
            ...
            <li className="ml-4">
              <a href='http://github.com/renn18' target={'_blank'} className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github" rel="noreferrer">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <a href='http://facebook.com/zpaver007' target={'_blank'} className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook" rel="noreferrer">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='ml-4'>
              <a href="http://google.com"><img src={getItOnPs} width={100} height={100} alt='pict'></img></a>
            </li>
          </ul>

          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://github.com/renn18/">Muhammad Putra Pratama</a>. All rights reserved.</div>
